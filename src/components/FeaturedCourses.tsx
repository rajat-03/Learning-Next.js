                            ...
                            <BackgroundGradient
                                ...
                                <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                                    ...
                                    <Link href={`/courses/${course.slug}`}>
                                        ...
                                        <button className="px-8 py-2 rounded-full relative 
                                        bg-slate-700 text-white text-sm hover:shadow-2xl 
                                        hover:shadow-white/[0.1] transition duration-200 border border-slate-600">
                                            <div className="absolute inset-x-0 h-px w-1/2 mx-auto -top-px 
                                            shadow-2xl  bg-gradient-to-r from-transparent via-teal-500 to-transparent" />
